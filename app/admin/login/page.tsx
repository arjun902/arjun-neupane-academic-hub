...
export default function LoginPage() {
  ...
  return (
    <main
      id="main-content"
      className="site-container grid min-h-[calc(100vh-76px)] items-center gap-10 py-14 lg:grid-cols-[0.85fr_0.6fr]"
    >
      <section>
        <p className="eyebrow">Staff administration</p>
        <h1 className="h1">Manage your academic hub</h1>
        <p className="lead mt-5">
          Sign in to publish teaching materials and manage the website. Students
          can browse all published courses without an account.
        </p>
        <div className="mt-8 grid gap-5 md:grid-cols-2">
          <Role
            title="Open learning"
            body="Students can read and download published learning materials without signing in."
          />
