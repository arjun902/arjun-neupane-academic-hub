...
export function UnitExplorer() {
  ...
  function downloadUnit() {
    const text = `${unit.title}\n${"=".repeat(unit.title.length)}\n\n${unit.body}\n\nUse this outline as a revision checklist. Select your course and enter the password provided by your instructor to access published files.`;
          ...
          <button
            ...
            className={`block w-full border-b border-line px-4 py-4 text-left text-sm font-extrabold last:border-b-0 ${
              active === index
                ...
                : "text-slate-700 hover:bg-teal/10"
            }`}
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <article className="card">
            ...
            <p className="mb-5 text-muted">
              Keep a short outline of the notes, practical work, assignment, and
              revision tasks for this unit.
            </p>
            <button
              type="button"
          ...
          <article className="card">
            ...
            <p className="mb-5 text-muted">
              Use the student dashboard to ask a question about this unit or
