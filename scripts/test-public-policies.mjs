...
// Load the real pgcrypto extension before the retained private migration.
...
await db.exec(readFileSync("supabase/migrations/202609200001_course_password_access.sql", "utf8"));
await db.exec(readFileSync("supabase/optional-public-learning/202609250001_public_learning.sql", "utf8"));
await role(null);
await check(
